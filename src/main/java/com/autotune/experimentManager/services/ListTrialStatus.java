        ...
        for (String runId : runIdList) {
            ...
            if(validRunId) {
                if (null != completeStatus && completeStatus.equalsIgnoreCase("true")) {
                    ...
                    API_RESPONSE.put(EMConstants.EMJSONKeys.EXPERIMENT_NAME, trialConfigJson.getString(EMConstants.EMJSONKeys.EXPERIMENT_NAME));
                ...
                if (null != summary && summary.equalsIgnoreCase("true")) {
                    ...
                    API_RESPONSE.put(EMConstants.EMJSONKeys.EXPERIMENT_NAME, inputJson.getString(EMConstants.EMJSONKeys.EXPERIMENT_NAME));
