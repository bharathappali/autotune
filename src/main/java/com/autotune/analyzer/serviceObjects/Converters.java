                ...
                if(containersList != null ) {
                    for (ContainerAPIObject containerAPIObject : containersList) {
                        ...
                        for (Metric metric : containerAPIObject.getMetrics()) {
                            ...
                            if (metric.getName().equalsIgnoreCase(AnalyzerConstants.MetricName.gpuCoreUsage.name())
                            ...
                            if (isAcceleratorMetric) {
                                if (null != metricResults.getMetadata()
                                    ...
                                    if (null != acceleratorMetricMetadata.getModelName()) {
                                        boolean isMIGSupported = RecommendationUtils.checkIfModelIsKruizeSupportedMIG(acceleratorMetricMetadata.getModelName());
                                        boolean isMIGPartition = (null != acceleratorMetricMetadata.getProfileName());
                                        AcceleratorDeviceData acceleratorDeviceData = new AcceleratorDeviceData(
